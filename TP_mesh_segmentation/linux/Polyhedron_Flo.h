...
public:
	...
	inline CGAL::Color& color() { return m_color; }
	inline CGAL::Color color() const { return m_color; }
	Point_d Pointd(){return  Point_d(CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().x(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().y(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().z());};
	operator const Point_d (){return  Point_d(CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().x(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().y(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().z());};
	operator Point_d (){return  Point_d(CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().x(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().y(),CGAL::HalfedgeDS_vertex_base<Refs, CGAL::Tag_true, Point>::point().z());};
